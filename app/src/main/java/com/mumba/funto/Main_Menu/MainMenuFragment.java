...
import com.mumba.funto.Discover.Discover_F;
import com.mumba.funto.Home.Home_F;
import com.mumba.funto.Main_Menu.RelateToFragment_OnBack.OnBackPressListener;
import com.mumba.funto.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.mumba.funto.Notifications.Notification_F;
import com.mumba.funto.Profile.Profile_Tab_F;
import com.mumba.funto.R;
import com.mumba.funto.SimpleClasses.Functions;
import com.mumba.funto.SimpleClasses.Variables;
import com.mumba.funto.Video_Recording.Video_Recoder_A;
...
public class MainMenuFragment extends RootFragment implements View.OnClickListener {
    ...
    private void setupTabIcons() {
        ...
        title1.setText("Home");
        title1.setTextColor(context.getResources().getColor(R.color.darkgray));
        ...
        imageView2.setImageDrawable(getResources().getDrawable(R.drawable.search));
        ...
        title2.setTextColor(context.getResources().getColor(R.color.darkgray));
        tabLayout.getTabAt(1).setCustomView(view2);


        View view3 = LayoutInflater.from(context).inflate(R.layout.item_add_tab_layout, null);
        ImageView image = view3.findViewById(R.id.image);
        image.setColorFilter(ContextCompat.getColor(context, R.color.darkgray), PorterDuff.Mode.SRC_IN);
        ...
        imageView4.setImageDrawable(getResources().getDrawable(R.drawable.messages));
        ...
        title4.setTextColor(context.getResources().getColor(R.color.darkgray));
        ...
        title5.setTextColor(context.getResources().getColor(R.color.darkgray));
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        ...
                        image.setColorFilter(ContextCompat.getColor(context, R.color.app_color),
                    ...
                    case 1:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.search));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.app_color),
                                android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.app_color));
                        break;
                    ...
                    case 3:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.messages));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.app_color),
                                android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.app_color));
                        break;
    ...
    public void OnHome_Click() {
        ...
        ImageView imageView1 = view1.findViewById(R.id.image);
        imageView1.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
        ...
        image.setImageDrawable(context.getResources().getDrawable(R.drawable.videos));
        image.setColorFilter(ContextCompat.getColor(context, R.color.colorwhite_50), PorterDuff.Mode.SRC_IN);
