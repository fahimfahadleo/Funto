...
import com.mumba.funto.Following.Following_F;
import com.mumba.funto.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.mumba.funto.Profile.Liked_Videos.Liked_Video_F;
import com.mumba.funto.Profile.UserVideos.UserVideo_F;
import com.mumba.funto.R;
import com.mumba.funto.See_Full_Image_F;
...
public class Profile_F extends RootFragment implements View.OnClickListener {
   ...
   public  TextView username,username2_txt,video_count_txt,user_referral;
   ...
   public  TextView follow_count_txt,fans_count_txt,heart_count_txt;
    ...
    public View init(){
        ...
        user_referral = view.findViewById(R.id.user_referral);
    ...
    public void Parse_data(String responce){
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                user_referral.setText(user_info.optString("username"));
